...
class AdController {
    async createAd(req, res) {
        let { elo, gender, high_age_lvl, is_active, low_age_lvl, tag, text, game_id, goal_id} = req.body
